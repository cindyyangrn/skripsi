...
class CBOWModel:
    def __init__(self, model_filepath='vectors/cbow/cbow.model', vector_size=150):
        """Inisialisasi dengan memuat model CBOW dan ukuran vektor"""
    ...
    def transform_texts_to_vectors(self, text_data):
        ...
        return np.array([self.get_average_vector(text.split()) for text in text_data])
